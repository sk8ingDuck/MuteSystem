...
import me.sk8ingduck.mutesystemspigot.mysql.DatabaseDetails;
...
public class SettingsConfig extends Config {
	...
	public void loadPermissions() {
		permissions = getFileConfiguration().getConfigurationSection("mutesystem.mute")
				.getKeys(false)
				.stream()
				.collect(Collectors.toMap(key -> "mutesystem.mute" + key,
						key -> getFileConfiguration().getConfigurationSection("mutesystem.mute").getInt(key)));
	}
